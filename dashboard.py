    ...
    if not filtered_dates.empty:
        ...
        if start_date == end_date:
            ...
            selected_range = st.sidebar.slider(
                "Select Date Range", min_value=start_date, max_value=end_date, value=(start_date, end_date))
            filtered_df = filtered_df[(filtered_df[date_column] >= selected_range[0]) & (
...
# ----------------------------
# Charts Display (without PNG export)
# ----------------------------
# Scatter Chart
